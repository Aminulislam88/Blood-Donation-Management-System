...
<input type="searchbar" id="myInput" placeholder="Search By Blood Group.."  name="search"><br><br>
        <a href="home.php"><button type="submit" name="home.php">home</button></a>
</form>
</div>
...
$sql = "SELECT name,lname,email,mobile,address,age,height,weight,bloodgroup,ldonate,image,bmi from userinfo INNER JOIN donar ON userinfo.id = donar.user_id order by id desc ";
