...
<?php
 ...
 <tbody>
           ...
           <tr> <th>Mobile</th>
            ...
            ?></td></tr>
           <tr> <th>Action</th>
               <td><a href="update1.php?id=<?php echo $row1['user_id']; ?>"><button type="submit" name="edit">Edit</button></a></td>
            <a href="home.php"><button type="submit" name="edit">home</button></a></tr>
